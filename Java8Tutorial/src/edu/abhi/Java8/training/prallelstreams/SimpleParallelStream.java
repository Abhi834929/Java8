...
public class SimpleParallelStream {
	...
	public static void main(String[] args) {
		...
		Stream.of("Ramesh", "Suresh", "Ganesh", "Magesh", "Rajesh", "Sudan", "Jagan", "Madan").parallel()
				.forEach(System.out::println);

		Stream<String> parallelStream = Arrays
				.asList("Ramesh", "Suresh", "Ganesh", "Magesh", "Rajesh", "Sudan", "Jagan", "Madan").parallelStream();

		Stream.of("John", "Mike", "Ryan", "Donald", "Matthew").parallel().forEach(System.out::println);

		Long sum = Stream.iterate(1L, (i) -> {
			return i + 1;
		}).limit(10).reduce(0L, Long::sum);

		System.out.println(sum);

		Long sum2 = Stream.iterate(1L, (i) -> {
			return i + 1;
